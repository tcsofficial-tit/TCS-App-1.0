...
TCS is a small and modest working Technical Society of T.I.T.&S. College comprising of 40-50 members. The society aims at making solutions to real-world problems and also put up interest in conducting various workshops and events in the college. The Society comprises of 3 branches that are strongly connected to its roots currently: Technical Team, Media Team and Meeting Team.''',
                  ...
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset('undraw_flutter_dev_wvqj.png',
                        fit:BoxFit.cover,
                      ),
                    ),
                  ),
...
''',
              ...
              child: Row(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Icon(Icons.android_rounded,size: 50,color: Colors.pinkAccent,
                        ),
                        RichText(
  ...
  #Let's Get Technical''',
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Icon(Icons.web_rounded,size: 50,color: Colors.white,
                        ),
                        RichText(
                          textAlign: TextAlign.center,
                          text: TextSpan(
  ...
  #Let's Get Technical''',
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Icon(Icons.app_registration,size: 50,color: Colors.pinkAccent,
                        ),
                        RichText(
                          textAlign: TextAlign.center,
                          text: TextSpan(
                ...
                children: <Widget>[
                  Center(
                    child: SizedBox(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(15),
                        child: Image.asset('undraw_project_team_lc5a.png',
                          fit:BoxFit.fill,
                        ),
                      ),
                    ),
                      ...
                      child: Column(
                        children: <Widget>[
                          CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 25,
                              backgroundImage: AssetImage("Dr.MukeshKumar(Mentor).jpg"),
                            ),
                          ),
                          RichText(
                            textAlign: TextAlign.center,
                      ...
                      child: Column(
                        children: <Widget>[
                          CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 25,
                              backgroundImage: AssetImage("Ms.ArchanaParmar.jpeg"),
                            ),
                          ),
                          RichText(
                            textAlign: TextAlign.center,
                      ...
                      child: Column(
                        children: <Widget>[
                          CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 25,
                              backgroundImage: AssetImage("undraw_voice_interface_eckp.png"),
                            ),
                          ),
                          RichText(
                            textAlign: TextAlign.center,
...
''',                            style: TextStyle(fontSize:5,height: 0.5,color: Colors.white)
                                          ...
                                          TextSpan(
                                            text: '''\n\nContact Us\n''',
                                            style: TextStyle(color: Colors.white,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold,fontSize: 26,height: 1,),
                                          ),
                                          TextSpan(
                                              text: '''
...
//
                                      ...
                                      //      launch('mailto:tcs.tit@gmail.com');
                                      //   },
                                      //       text: '''\t\ttcs.tit@gmail.com''',
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  RadiantGradientMask(
                                    child: IconButton(
                                      onPressed: ()
                                      {launch('mailto:tcs.tit@gmail.com?subject=');},
                                      icon: Icon(FontAwesomeIcons.googlePlus,color: Colors.white,),
                                      iconSize: 45,
                                    ),
                                  ),
                                  SizedBox(width: 10,),
                                  ...
                                  RadiantGradientMask(
                                    child: IconButton(
                                      onPressed: ()
                                      {launch('https://www.instagram.com/tcs_society/');},
                                  ...
                                  RadiantGradientMask(
                                    child: IconButton(
                                      onPressed: ()
                                      {launch('https://www.linkedin.com/company/t-i-t-s-computer-society');},
